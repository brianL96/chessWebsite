...
const socket = io('/classicGame');

let opponentUsername;
let opponentFound = false;
let currentRoomIndex = sessionStorage.getItem("classicCurrentRoom");
let currentPosition = sessionStorage.getItem("classicCurrentPosition");
...
if(currentRoomIndex !== null && currentPosition !== null && username !== null){
	...
	currentRoomIndex = parseInt(sessionStorage.getItem("classicCurrentRoom"));
	currentPosition = parseInt(sessionStorage.getItem("classicCurrentPosition"));
...
socket.on('clientDisconnect', (data) => {
	...
	sessionStorage.removeItem("classicCurrentRoom");
	sessionStorage.removeItem("classicCurrentPosition");
	disconnected = true;
